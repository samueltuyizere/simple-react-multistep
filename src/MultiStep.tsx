...
export default function MultiStep(props: MultiStepPropsBase) {
  ...
  const prevButton: NavButton =
    typeof props.prevButton === "undefined" ? {} : props.prevButton;
  const nextButton: NavButton =
    typeof props.nextButton === "undefined" ? {} : props.nextButton;

  const directionType =
    typeof props.direction === "undefined" ? "row" : props.direction;
  const [activeStep, setActiveStep] = useState(
    getStep(0, props.activeStep, numberOfSteps),
  );
      ...
      return (
        <Li
          ...
          style={{
            ...stepCustomStyle,
            transform:
              directionType == "column" ? "rotate(90deg)" : "rotate(0deg)",
          }}
